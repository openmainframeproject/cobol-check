...
public class TestSuiteErrorLogTest {
    ...
    public void it_catches_unexpected_keyword_inside_mock_block() {
        ...
        expectedResult += "Cannot have Cobol Check keyword <END-BEFORE> inside a MOCK block" + Constants.NEWLINE
                + Constants.NEWLINE;
    ...
    public void it_catches_unexpected_keyword_inside_before_each_block() {
        ...
        expectedResult += "SYNTAX ERROR in file: null:4:8:" + Constants.NEWLINE;
        expectedResult += "Unexpected token on line 4, index  8:" + Constants.NEWLINE;
        expectedResult += "Cannot have Cobol Check keyword <VERIFY> inside a BEFORE EACH block" + Constants.NEWLINE
                + Constants.NEWLINE;
    ...
    public void it_catches_two_identical_mocks_local() {
        ...
        expectedResult += "Mock <000-START> already exists in this Local testcase scope" + Constants.NEWLINE
                + Constants.NEWLINE;
    ...
    public void it_catches_two_identical_mocks_global() {
        ...
        expectedResult += "Mock <000-START> already exists in this Global testsuite scope" + Constants.NEWLINE
                + Constants.NEWLINE;
    ...
    public void it_catches_verify_with_no_mock() {
        ...
        expectedResult += "Verify references non existent mock. Mock does not exist for:  SECTION 000-START with no arguments"
