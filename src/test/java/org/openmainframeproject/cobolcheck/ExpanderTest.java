...
public class ExpanderTest {
    ...
    private String expected3 = 
            ...
            "           .                                                                    " + Constants.NEWLINE +
            "                                                                                 " + Constants.NEWLINE +
            "      *CALL \"PROGRAM\" USING VALUE-1 ON EXCEPTION PERFORM 100-WELCOME.         " + Constants.NEWLINE +
            "            CONTINUE                                                            " + Constants.NEWLINE +
            "           .                                                                    ";
    ...
    private String expected4 = 
            ...
            "           .                                                                    " + Constants.NEWLINE +
            "                                                                                 " + Constants.NEWLINE +
            "      *CALL \"PROGRAM\" USING VALUE-1 ON EXCEPTION DISPLAY \"HELLO WORLD\".     " + Constants.NEWLINE +
            "            CONTINUE                                                            " + Constants.NEWLINE +
            "           .                                                                    ";
    ...
    private String expected5 = 
            ...
            "           .                                                                    " + Constants.NEWLINE +
            "                                                                                 " + Constants.NEWLINE +
            "      *CALL \"PROGRAM\" USING VALUE-1 ON EXCEPTION CALL \"PROGRAM2\" USING V    " + Constants.NEWLINE +
            "      * ALUE-1 ON EXCEPTION DISPLAY \"HELLO WORLD\" END-CALL END-CALL           " + Constants.NEWLINE +
            "            CONTINUE                                                            " + Constants.NEWLINE +
